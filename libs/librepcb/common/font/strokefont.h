...
class StrokeFont final : public QObject
{
    ...
    public:
        ...
        QVector<Path> stroke(const QString& text, const Length& height,
                             const Length& strokeWidth, const Ratio& lineSpacingFactor,
        ...
        QVector<Path> strokeGlyph(const QChar& glyph, const Length& height, Length& spacing) const noexcept;
    ...
    private:
        ...
        Length calcGlobalLetterSpacing(const Length& height, const Length& strokeWidth) const noexcept;
