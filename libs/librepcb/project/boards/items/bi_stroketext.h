                            ...
                            public IF_StrokeTextObserver
{
    ...
    private: // Methods
        ...
        void strokeTextLayerNameChanged(const QString& newLayerName) noexcept override {Q_UNUSED(newLayerName); updateAnchor();}
        void strokeTextTextChanged(const QString& newText) noexcept override {Q_UNUSED(newText);}
        void strokeTextPositionChanged(const Point& newPos) noexcept override {Q_UNUSED(newPos); updateAnchor();}
        ...
        void strokeTextLineSpacingFactorChanged(const Ratio& factor) noexcept override {Q_UNUSED(factor);}
